...
#Imprimir el valor de la variable myString
print(myString)
...
#Creamos la variable fisrtString y dentro de ella guardamos el valor de "water"
firstString = "water"
...
#Para imprimir usando format() vamos a poner un {} por cada variable y el format va a poner el valor de las variables en el orden que las estamos usando
